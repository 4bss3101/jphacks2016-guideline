...
### <a name="section1">1. GitHub の JPHACKS organization からメンバー招待の確認と承認</section>
...
### <a name="section2">2. チームリポジトリの確認</section>
...
### <a name="section2">3. リポジトリの設定(公開か非公開かの設定)</section>
...
## <a name="section4">4. (任意)開発予定プロダクトの登録・README-before.mdの完成</section>
...
## <a name="section5">5. 最終的に開発したプロダクトの登録・README.mdの記入</section>
...
## <a name="section6">6. DEVPOSTへの作品情報の登録</section>
...
## <a name="section7">7. 提出フォームによるプロダクト情報の最終提出</section>
